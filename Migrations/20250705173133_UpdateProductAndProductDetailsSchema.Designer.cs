...
namespace NMCNPM_Nhom7.Migrations
{
    ...
    [Migration("20250705173133_UpdateProductAndProductDetailsSchema")]
    partial class UpdateProductAndProductDetailsSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProductDetailModel", b =>
                {
                    b.Property<int>("IProductDetailID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("iProductDetailID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IProductDetailID"));

                    b.Property<decimal?>("FImportPrice")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("fImportPrice");

                    b.Property<decimal>("FSellPrice")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("fSellPrice");
                    ...
                    b.HasKey("IProductDetailID");

                    b.HasIndex("ISupplierID");

                    b.HasIndex("IUnitID");

                    b.HasIndex("IProductID", "ISupplierID", "IUnitID")
                        .IsUnique()
